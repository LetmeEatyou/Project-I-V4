...
5. Use **Settings** to control haptics and reminders or export a JSON backup.
...
- Local notifications before and at the start of upcoming blocks on supported native devices
